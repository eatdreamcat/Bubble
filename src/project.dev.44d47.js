  ...
  BubbleMove: [ function(require, module, exports) {
    ...
    var BubbleMove = function(_super) {
      ...
      BubbleMove.prototype.checkCollisionBubble = function() {
        ...
        var _loop_1 = function(index) {
          ...
          if (CMath.Distance(bubblePos, bubble.node.position) <= 2 * this_1.radis * .8) {
            ...
            this_1.onCollision(targetIndex, callback);
            return {
              value: void 0
            };
          }
      ...
      BubbleMove.prototype.shoot = function(deltaP) {
        if ("Shooter" != this.node.parent.name) return;
  ...
  Bubble: [ function(require, module, exports) {
    ...
    var Bubble = function(_super) {
      ...
      Bubble.prototype.updateIndex = function() {
        "" == this.IndexLabel.string ? this.IndexLabel.string = this.index.toString() : this.IndexLabel.string = "";
      };
    ...
    var GameScene = function(_super) {
      ...
      GameScene.prototype.getShooterBubble = function(count) {
        ...
        bubble.runAction(cc.spawn(cc.scaleTo(.2, 1), cc.fadeTo(.2, 255), cc.moveTo(.3, 0, 0), cc.callFunc(function() {
          if (_this.BulletArray.childrenCount % 4) {
    ...
    var Guide = function(_super) {
      ...
      Guide.prototype.nextPage = function() {
        if (this.GuideView.getCurrentPageIndex() >= this.GuideView.content.childrenCount - 1) this.hide(); else {
          ...
          nextPageIndex >= this.GuideView.content.childrenCount - 1 && (this.Next.node.getComponent(cc.Sprite).spriteFrame = this.ButtonAtlas.getSpriteFrame("new_close"));
  ...
  ShooterLayer: [ function(require, module, exports) {
    ...
    var ShooterLayer = function(_super) {
      ...
      ShooterLayer.prototype.updatePoint = function(k, direction) {
        while (this.Point.childrenCount > this.pointCount) GameFactory_1.gFactory.putPoint(this.Point.children[0]);
      ...
      ShooterLayer.prototype.onTouchStart = function(e) {
        ...
        if (null != this.curTouchID) return;
      ...
      ShooterLayer.prototype.onTouchMove = function(e) {
        if (this.Shooter.childrenCount <= 0) return;
        if (!Game_1.Game.isStart) return;
        if (null == this.curTouchID || this.curTouchID != e.getID()) return;
        this.ShooterStar.active = true;
        this.Point.active = true;
        this.updateStarPosition(e.getLocation());
      };
      ShooterLayer.prototype.onTouchEnd = function(e) {
        ...
        this.ShooterStar.y >= SHOOTER_LIMIT_HEIGHT && EventManager_1.gEventMgr.emit(EventName_1.GlobalEvent.SHOOT, dP);
      };
  ...
  Treasure: [ function(require, module, exports) {
    ...
    var Treasure = function(_super) {
      ...
      Treasure.prototype.getTreasure = function() {
        ...
        this.node.runAction(cc.sequence(cc.delayTime(.1), cc.scaleTo(.1, 1.44), cc.delayTime(.3), cc.callFunc(function() {
          Game_1.Game.addScore(Const_1.BubbleType["Treasure_" + _this.node.name], parseInt(_this.node.name), parseInt(_this.node.name) / 200 * .1 + 1, CMath.ConvertToNodeSpaceAR(_this.node, Game_1.Game.TopNode));
...
}, {}, [ "Bubble", "BubbleMove", "Const", "AudioController", "EventManager", "EventName", "Game", "GameFactory", "StepController", "BubbleMatrix", "GameScene", "Guide", "ResultLayer", "ShooterLayer", "Treasure", "HashMap", "celerx" ]);